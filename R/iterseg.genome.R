...
#'  and a dataframe with the predictions from the regression tree (regtreepreds)
#' @examples
...
iterseg.genome <- function(df,png_filename, cpvalue = NA, upper.y.lim = 5, lower.y.lim = 5){

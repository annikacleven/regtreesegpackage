...
Using the optimal cp value, iteration, weighting, or a combination of all three, $log_2$ ratio data in regards to copy number variants can be segmented using a regression tree approach to identify amplifications or deletions in the sample. 

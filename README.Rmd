...
## *seg.genome*:
### Inputs: dataframe(required), png_filename(required), upper.y.lim (optional), lower.y.lim (optional), cpvalue (optional)
...
A cpvalue can be specified in the input.  By specifying a cp value, this cp value will be used to segment each chromosome. If no cp value is specified the optimal cp value will be used.   

## *seg.chr*
### Inputs: dataframe(required), chromid (required), cpvalue (optional)

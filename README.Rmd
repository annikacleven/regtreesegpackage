...
knitr::include_graphics("/home/mayo/m252318/R/functionworkflow2.png.jpg")
```
...
```{r echo=FALSE, out.width="100%", fig.align='center'}
knitr::include_graphics("/home/mayo/m252318/R/iteration.jpg")
```
...
```{r echo=FALSE, out.width="100%", fig.align='center'}
knitr::include_graphics("/home/mayo/m252318/R/itersegworkflow.jpg")
```
